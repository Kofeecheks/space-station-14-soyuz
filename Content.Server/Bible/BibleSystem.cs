...
namespace Content.Server.Bible
{
    public sealed class BibleSystem : EntitySystem
    {
        ...
        private void OnAfterInteract(EntityUid uid, BibleComponent component, AfterInteractEvent args)
        {
            ...
            // Kofeecheks Bible revival integration: LicenseRef-Kofeecheks
        ...
        // Kofeecheks Bible revival integration: LicenseRef-Kofeecheks
        private void TryReviveDeadTarget(
            ...
            UseDelayComponent useDelay)
        {
            ...
            {
                _popupSystem.PopupEntity(Loc.GetString("bible-revive-already-tried"), user, user,
            ...
            {
                _popupSystem.PopupEntity(Loc.GetString("defibrillator-rotten"), user, user,
                    PopupType.MediumCaution);
            ...
            {
                _popupSystem.PopupEntity(Loc.GetString(unrevivable.ReasonMessage), user, user,
                    PopupType.MediumCaution);
                _audio.PlayPvs(component.BibleHitSound, user);
                return;
            }
            ...
            if (!_random.Prob(component.ReviveDeadChance))
            {
                ...
                _popupSystem.PopupEntity(othersFailMessage, user, Filter.PvsExcept(user), true,
            ...
            {
                _popupSystem.PopupEntity(Loc.GetString("bible-revive-fail-self",
